...
export const metadata: Metadata = {
  ...
  description: 'Soluções de software personalizadas para sua empresa em Porto Alegre, RS. Desenvolvimento de sistemas, aplicativos e automação de processos. Orçamento gratuito!',
  keywords: 'desenvolvimento de sistemas Porto Alegre, software personalizado RS, sistema empresarial, automação de processos',
  openGraph: {
    title: 'Desenvolvimento de Sistemas em Porto Alegre | dois.du',
    description: 'Soluções de software personalizadas para sua empresa em Porto Alegre, RS. Desenvolvimento de sistemas, aplicativos e automação de processos.',
